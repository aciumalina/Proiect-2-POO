////clasa Serviciu a fost luata din primul proiect
//#include <iostream>
//#include <string>
//#include <typeinfo>
//using namespace std;
...
//    virtual void afisareGen() const = 0;                                              //metoda care face clasa abstracta
//
...
//    PacientSiDoctor(const string &nume, const string &prenume, const string &cnp, int cod, int varsta, bool asigurare, float rating, const string &specializare, int anulAngajarii, int discount):Persoana(nume, prenume, cnp, cod), Pacient(nume, prenume, cnp, cod, varsta, asigurare), Doctor(nume, prenume, cnp, cod, rating, specializare, anulAngajarii)
//    {
...
//    cout << "Pentru a calcula discount-ul aditional pentru un doctor care urmeaza tratament, alegeti optiunea 9 " << endl;
//    cout<< "Pentru afisarea genului unei persoane din sistem, alegeti optiunea 10"<<endl;
//    cout << "Orice alta optiune inchide meniul" << endl;
//}
//
...
//                if(i == nrVec) {
//                    (*vec)[i] = new Doctor;
//                    (*vec)[nrVec++]->citire(cin); break;}           //daca ajung la i == nrVec inseamna ca toate pozitiile sunt ocupate, deci voi introduce obiectul pe pozitia nrVec si incrementez nrVec
//            }
//        }
//
//        else if (opt == 2)
...
//                    vec[i]->citire(cin);                              //modificare presupune reintroducerea obiectului prin citire, nu doar modificarea unei singure variabile
//                    break;
//                }
//            }
//            if (i == nrVec) {
//                cout << "Nu s-a gasit niciun doctor cu codul specificat" << endl;
//                break;
//            }
//            break;
//        }
...
//        if (opt == 1) {
//            int id, i;
//            cout << "Introduceti codul doctorului pe care doriti sa il stergeti " << endl;
//            cin >> id;
//            for (i = 0; i < nrVec; i++) {
//                if (vec[i]->getCod() == id && vec[i]->getNume() != "Anonim") {           //verific ca obiectul sa nu fi fost sters deja
//                    cout << "Doctorul cu codul " << id << " a fost sters" << endl;
//                    vec[i]->setNume("Anonim");                                                //prin numele setat la "Anonim" indic ca acel doctor nu mai exista
//                    break;
//                }
//            }
...
//                    pac[i].setNume("Anonim");          //acelasi lucru ca la doctor, setez numele la "Anonim" pentru a sti daca un obiect a devenit inactiv
//                    break;
//                }
//            }
...
//    Pacient *pac = new Pacient[sizePac];
//    Serviciu *serv = new Serviciu[sizeServ];
//
...
//            for(i = 0; i < nrVec; i++)
//            {
//                if(vec[i]->getCod() == cod && typeid(*vec[i]) == typeid(PacientSiDoctor))
//                {
//                    dynamic_cast<PacientSiDoctor*>(&*vec[i])->calculReducereExtra();
//                    break;
//                }
//
//                else if (vec[i]->getCod() == cod && typeid(*vec[i]) != typeid(PacientSiDoctor))
//                {
//                    cout<<"Doctorul nu urmeaza tratament la acest spital la momentul actual"<< endl;
//                    break;
//                }
//            }
//            if(i == nrVec) cout << "Nu a fost gasit niciun doctor cu codul introdus"<<endl;
//        }
//
//        else if(nrOpt == 10)
//        {
//            cout<<"Introduceti sectiunea in care se afla persoana cautata: 1-Doctor, 2-Pacient"<<endl;
//            int opt;
//            cin >> opt;
//            if(opt == 1)
//            {
//                cout<<"Introduceti codul doctorului cautat"<<endl;
//                int cod, i;
//                cin >> cod;
//                for(i = 0; i < nrVec; i++)
//                {
//                    if(vec[i]->getNume() != "Anonim" && vec[i]->getCod() == cod)
//                    {
//                        vec[i]->afisareGen();
//                        break;
//                    }
...
//                for(i = 0; i<nrPac; i++)
//                {
//                    if(pac[i].getNume() != "Anonim" && pac[i].getCod() == cod)
//                    {
//                        pac[i].afisareGen();
//                        break;
//                    }
